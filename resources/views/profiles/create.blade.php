        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                  ...
                  <form class="form-horizontal" role="form" method="POST" action="/profiles">
                        ...
                        <div class="form-group{{ $errors->has('twitter_page') ? ' has-error' : '' }}">
                            <label for="twitter_page" class="col-md-4 control-label">Twitter Page</label>

                            <div class="col-md-6">
                                <input id="twitter_page" type="text" class="form-control" name="twitter_page" value="{{ old('twitter_page') }}" required>
